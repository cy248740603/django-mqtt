...
class Device(models.Model):
    deviceID = models.CharField('设备ID',primary_key=True, max_length=16)
    info = models.CharField('基本信息',max_length=200)
    created_time = models.DateTimeField('生成时间')
...
class Device_Data(models.Model):
    device = models.ForeignKey(Device,related_name='data',verbose_name='设备',on_delete=models.CASCADE)
    #999.00
    power = models.DecimalField('功率',max_digits=5, decimal_places=2)
    created_time = models.DateTimeField('生成时间',auto_now_add=True)
    class Meta:
        verbose_name = '数据'
